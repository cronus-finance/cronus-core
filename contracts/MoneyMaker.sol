...
import "./interfaces/ICronusFactory.sol";
import "./libraries/CronusLibrary.sol";
...
/// @title Money Maker
/// @author Cronus
/// @notice MoneyMaker receives 0.05% of the swaps done on Cronus Finance in the form of an LP. It swaps those LPs
/// to a token of choice and sends it to the CronusBar
contract MoneyMaker is Ownable {
    ...
    /// @param slippage The accepted slippage, in basis points aka parts per 10,000 so 5000 is 50%
    /// @return amountOut The amount of `toToken` sent to CronusBar
    function _toToken(
        address token,
        uint256 amountIn,
        uint256 slippage
